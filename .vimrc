...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call setline(3, "# Author: xiaochenwang94") 
		call setline(4, "# Mail: xiaochenwang94@gmail.com") 
    ...
    elseif &filetype == 'python'
		...
		call append(line(".")+2, "# Author: xiaochenwang94") 
		call append(line(".")+3, "# Mail: xiaochenwang94@gmail.com") 
    ...
    elseif &filetype == 'ruby'
		...
		call append(line(".")+1, "# Author: xiaochenwang94") 
		call append(line(".")+2, "# Mail: xiaochenwang94@gmail.com") 
